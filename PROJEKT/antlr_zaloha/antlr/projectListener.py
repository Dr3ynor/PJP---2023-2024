...
class projectListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by projectParser#neg.
    def enterNeg(self, ctx:projectParser.NegContext):
        pass

    # Exit a parse tree produced by projectParser#neg.
    def exitNeg(self, ctx:projectParser.NegContext):
        pass
